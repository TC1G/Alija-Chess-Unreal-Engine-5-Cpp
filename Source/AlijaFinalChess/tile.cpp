...
Atile::Atile() {
	...
	LightMaterial = ConstructorHelpers::FObjectFinder<UMaterial>(TEXT("Material'/Game/Materials_Assets/tile_W.tile_W'")).Object; 
	DarkMaterial = ConstructorHelpers::FObjectFinder<UMaterial>(TEXT("Material'/Game/Materials_Assets/tile_B.tile_B'")).Object; 
	HighlightMaterial = ConstructorHelpers::FObjectFinder<UMaterial>(TEXT("Material'/Game/Materials_Assets/Select_Highlight.Select_Highlight'")).Object; 
}
