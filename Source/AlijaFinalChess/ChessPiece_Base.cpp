...
AChessPiece_Base::AChessPiece_Base() {
	...
	// Creates static mesh and assign it as its root	(MORAO SAM OVAKO SAHA HALALI) - INSIDE JOKE
	...
	static ConstructorHelpers::FObjectFinder<UMaterial> GetWhiteMaterial(TEXT("Material'/Game/Materials_Assets/piece_W.piece_W'")); 
	...
	static ConstructorHelpers::FObjectFinder<UMaterial> GetBlackMaterial(TEXT("Material'/Game/Materials_Assets/piece_B.piece_B'")); 
	if (GetBlackMaterial.Succeeded())
		BlackMaterial = GetBlackMaterial.Object;

	// Sets the Selection Highlight's Material
	static ConstructorHelpers::FObjectFinder<UMaterial> GetSelectedMaterial(TEXT("Material'/Game/Materials_Assets/Select_Highlight.Select_Highlight'")); 
	if (GetSelectedMaterial.Succeeded())
		SelectedMaterial = GetSelectedMaterial.Object;

	// Set the to-be Eliminated Material
	static ConstructorHelpers::FObjectFinder<UMaterial> GetEliminateMaterial(TEXT("Material'/Game/Materials_Assets/Eliminate_Highlight.Eliminate_Highlight'")); 
